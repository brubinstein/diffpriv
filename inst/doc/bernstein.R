...
## ---- fig.show='hold', fig.width=5, fig.height=4, fig.cap = "Bernstein polynomial approximation (blue) vs target (red)."----
...
## ---- fig.show='hold', fig.width=5, fig.height=4, fig.cap = "Kernel regression on 1D training data (points): non-private model (red dashed); non-private Bernstein polynomial approximation (green dotted); private Bernstein mechanism (blue solid)."----
xlim <- c(0, 1)
